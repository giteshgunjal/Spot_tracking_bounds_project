...
def query_arm_joint_trajectory(t):
    ...
    joint_positions[1] = nominal_pose[1] + 0.4 * math.sin( w * t)
    joint_positions[2] = nominal_pose[2] + 0.2 * math.sin(2 * w * t)
    joint_positions[3] = nominal_pose[3] + 0.3 * math.cos(3 * w * t)
    ...
    joint_velocities[1] = 0.4 * w * math.cos( w * t)
    joint_velocities[2] = 0.2 * 2 * w * math.cos(2 * w * t)
    joint_velocities[3] = -0.3 * 3 * w * math.sin(3 * w * t)
